...
const DemoComputer = (props) => {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF(`${BASE_URL}models/computer.glb`);
  useAnimations(animations, group);

  const txt = useVideoTexture(props.texture ? props.texture : `${BASE_URL}textures/project/project1.mp4`, { flipY: false });
...
useGLTF.preload(`${BASE_URL}models/computer.glb`);
